...
2. You will add `render` method (which is  a prototype method) to render each employee name, department, and employee salary using `document.write()` or `innerHTML` as the following.
